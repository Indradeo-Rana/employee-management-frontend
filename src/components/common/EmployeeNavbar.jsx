  ...
  return (
    <header style={styles.header}>
      ...
      <div style={styles.right}>
        {/* Clickable profile — goes to profile page */}
        <button
        ...
        >
          ...
          <div style={{ textAlign: "left" }}>
            ...
            <p style={styles.userSub}>Edit Profile</p>
          </div>
        </button>
...
const styles = {
  header: {
    ...
    background: "rgba(10,15,30,0.97)", borderBottom: "0.5px solid rgba(255,255,255,0.08)",
    backdropFilter: "blur(10px)", display: "flex", alignItems: "center",
    padding: "0 1.5rem", gap: "1.5rem", zIndex: 100, fontFamily: "'DM Sans', sans-serif",
  },
  logo: { display: "flex", alignItems: "center", gap: "8px", flexShrink: 0 },
  logoIcon: {
    width: "30px", height: "30px", background: "linear-gradient(135deg,#6366f1,#22d3ee)",
    borderRadius: "8px", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "14px",
  },
  logoText: { fontFamily: "'Sora', sans-serif", fontWeight: 700, fontSize: "16px", color: "#fff" },
  ...
  navBtn: {
    ...
    transition: "all 0.15s ease", height: "60px",
  },
  ...
  userName: { color: "#e8eaf0", fontSize: "13px", fontWeight: 600, lineHeight: 1.2 },
  userSub:  { color: "rgba(232,234,240,0.35)", fontSize: "10px" },
  logoutBtn: {
    background: "rgba(239,68,68,0.08)", border: "0.5px solid rgba(239,68,68,0.25)",
    borderRadius: "8px", padding: "6px 14px", color: "rgba(239,68,68,0.8)",
